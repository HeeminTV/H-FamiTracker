...
I7e02_CPU::I7e02_CPU (double clock)
{
...
{
  static_cast < I7e02_CPU * >(__THIS)->Write (adr, val);
}

UINT32 Callback readByte (void *__THIS, UINT32 adr)
{
  UINT32 val = 0;
  static_cast < I7e02_CPU * >(__THIS)->Read (adr, val);
  return val;
}

void I7e02_CPU::run_from (UINT32 address)
{
	#if TRACE
...
void I7e02_CPU::SetMemory (IDevice * b)
{
  bus = b;
}

bool I7e02_CPU::Write (UINT32 adr, UINT32 val, UINT32 id)
{
  #if DEBUG_RW
...
bool I7e02_CPU::Read (UINT32 adr, UINT32 & val, UINT32 id)
{
  if (bus)
  {
...
void I7e02_CPU::SetLogger (CPULogger* logger)
{
	log_cpu = logger;
}

unsigned int I7e02_CPU::GetPC() const
{
	return context.PC;
}

void I7e02_CPU::StealCycles(unsigned int cycles)
{
	stolen_cycles += cycles;
}

void I7e02_CPU::EnableNMI(bool enable)
{
	enable_nmi = enable;
}

void I7e02_CPU::UpdateIRQ(int device, bool irq)
{
