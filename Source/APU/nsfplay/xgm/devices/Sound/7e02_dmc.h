...
namespace xgm
{
  class I7e02_APU; // forward declaration

  /** Bottom Half of APU **/
  class I7e02_DMC:public ISoundChip
  {
  public:
    enum
    { 
  ...
  public:
    ...
    // frame sequencer
    I7e02_APU* apu; // apu is clocked by DMC's frame sequencer
