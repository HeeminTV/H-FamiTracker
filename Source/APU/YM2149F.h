...
class CYM2149FChannel : public CChannel
{
public:
	friend class CYM2149F;

	CYM2149FChannel(CMixer *pMixer, uint8_t ID);
...
class CYM2149F : public CSoundChip
{
public:
	CYM2149F(CMixer *pMixer);
	virtual ~CYM2149F();
