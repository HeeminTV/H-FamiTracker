...
#include "APU/nsfplay/xgm/devices/Sound/7e02_apu.h"
#include "APU/nsfplay/xgm/devices/Sound/7e02_dmc.h"
#include "APU/nsfplay/xgm/devices/device.h"


// class for simulating CPU memory, used by the DPCM channel
class C7E02SampleMem : public xgm::IDevice
{
public:
	C7E02SampleMem() : m_pMemory(0), m_iMemSize(0) {
	};
...
class C7E02 : public CSoundChip2
{
public:
	C7E02();
...
public:
	void UpdateMixing7E02_APU1(double v, bool UseSurveyMix = false);
	void UpdateMixing7E02_APU2(double v, bool UseSurveyMix = false);

	void	ClockSequence();		// // //
	
	void	ChangeMachine(int Machine);
	
	C7E02SampleMem *GetSampleMemory();		// // //
...
private:
	...
	C7E02SampleMem m_SampleMem;

	xgm::I7e02_APU m_Apu1;
	xgm::I7e02_DMC m_Apu2;
