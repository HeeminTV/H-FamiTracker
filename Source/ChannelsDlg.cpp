...
const int CHILD_ITEMS_ID[ROOT_ITEM_COUNT][9] = {
	// 2A03
	{CHANID_FWG1, CHANID_FWG2, CHANID_WAVEFORM, CHANID_NOISE, CHANID_DPCM},
	// VRC 6
	...
	{CHANID_N163_CH1, CHANID_N163_CH2, CHANID_N163_CH3, CHANID_N163_CH4, CHANID_N163_CH5, CHANID_N163_CH6, CHANID_N163_CH7, CHANID_N163_CH8}, 
	 // S5B
	{CHANID_SY1202_CH1, CHANID_SY1202_CH2, CHANID_SY1202_CH3}
};
...
/*
	AddChannel(CHANID_FWG1);
	AddChannel(CHANID_FWG2);
	AddChannel(CHANID_WAVEFORM);
